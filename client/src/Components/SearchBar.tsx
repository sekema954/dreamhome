  ...
  return (
    <div className="w-full max-w-4xl mx-auto p-4">
      <div className="flex flex-wrap gap-2 mb-4">
        <p onClick={()=>setActive('sell')} className={`px-4 py-2 bg-white rounded-t-md border cursor-pointer flex-1 text-center ${isActive === 'sell' ? 'bg-green-300 text-green-800': ''}`}>Sell</p>
        <p onClick={()=>setActive('rent')} className={`px-4 py-2 bg-white rounded-t-md border cursor-pointer flex-1 text-center ${isActive === 'rent' ? 'bg-green-300 text-green-800': ''}`}>Rent</p>
        <p onClick={()=>setActive('buy')} className={`px-4 py-2 bg-white rounded-t-md border cursor-pointer flex-1 text-center ${isActive === 'buy' ? 'bg-green-300 text-green-800' : ''}`}>Buy</p>
      </div>
