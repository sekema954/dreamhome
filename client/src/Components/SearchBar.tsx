  ...
  return (
    <div className="w-full max-w-4xl mx-auto p-4">
      <div className="flex flex-wrap gap-2 mb-4">
        <p onClick={()=>setActive('sell')} className={`px-4 py-2 bg-white rounded-t-md border cursor-pointer flex-1 text-center ${isActive === 'sell' ? 'bg-green-300 text-green-300': ''}`}>Sell</p>
        <p onClick={()=>setActive('rent')} className={`px-4 py-2 bg-white rounded-t-md border cursor-pointer flex-1 text-center ${isActive === 'rent' ? 'bg-green-300 text-green-300': ''}`}>Rent</p>
        <p onClick={()=>setActive('buy')} className={`px-4 py-2 bg-white rounded-t-md border cursor-pointer flex-1 text-center ${isActive === 'buy' ? 'bg-green-300 text-green-300' : ''}`}>Buy</p>
      </div>
    ...
    {isActive === 'rent' &&(
        <div className="bg-white rounded-b-md shadow-md flex flex-col md:flex-row items-center p-4 gap-4">
            ...
            <div className="flex items-center gap-2 border rounded-md px-4 py-2 shadow-md w-full md:w-auto">
                ...
                <select name="houseType" id="houseType" className="focus:outline-none flex-1 bg-white">
            ...
            <div className="flex items-center gap-2 border rounded-md px-4 py-2 shadow-md w-full md:w-auto">
                ...
                <select name="priceRange" id="priceRange" className="focus:outline-none flex-1 bg-white">
